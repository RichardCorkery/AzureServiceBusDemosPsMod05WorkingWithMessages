...
namespace WorkingWithMessages.Receiver
{
    class ReceiverConsole
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            //Demo5: Send and Receive Multiple Messages: In a batch list (The perform will increase using the sending method vs the method used in Demo 4)
            //ReceiveAndProcessPizzaOrders(1);

            //ReceiveAndProcessPizzaOrders(5);
            //ReceiveAndProcessPizzaOrders(100);
