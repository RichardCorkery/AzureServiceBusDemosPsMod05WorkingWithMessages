...
namespace WorkingWithMessages.Sender
{
    class SenderConsole
    {
        static async Task Main(string[] args)
        {
            ...
            //Demo5: Send and Receive Multiple Messages: In a batch list (The perform will increasing using this method vs the method used in Demo 4 above) 
        ...
        {
            WriteLine("SendTextString", ConsoleColor.Cyan);
